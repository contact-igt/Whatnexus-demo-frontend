    ...
    return (
        <div className={cn("min-h-screen font-sans transition-colors duration-500", bg)}>
            ...
            <main className="max-w-8xl mx-auto px-6 sm:px-10 pt-36 pb-28">
                ...
                {/* ── Intro ─────────────────────────────────────── */}
                <P cls={body}>
                    <B d={D}>Invictus Global Tech Pvt Ltd</B> provides <B d={D}>WhatsNexus</B>, an AI-powered messaging automation
                ...
                <section id="contact">
                    ...
                    <div className={cn(
                        ...
                        <div>
                            <p className={cn("text-base font-black mb-1", strong)}>Invictus Global Tech Pvt Ltd</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className={cn("text-sm", body)}>
                                        LIG 13/19, NH3, Vanjinathan Street, Maraimalai Nagar, Chennai - 603209
                                    </p>
                                </div>
                            </div>
                        </div>
