        ...
        <div className={cn("min-h-screen font-sans transition-colors duration-500", bg)}>
            ...
            <main className="max-w-8xl mx-auto px-6 sm:px-10 pt-36 pb-28">
                ...
                <section id="services">
                    ...
                    <P cls={body}><B d={D}>3.2</B> The Platform may integrate with third-party services such as the WhatsApp Business Platform (Cloud API), CRMs, automation tools, and analytics platforms. Use of such third-party services may be subject to their own terms and policies.</P>
                    <P cls={body}><B d={D}>3.3</B> We may update, modify, or discontinue features to improve performance, security, or compliance.</P>
                </section>
                ...
                <section id="privacy">
                    ...
                    <ul className={cn("mt-2 mb-5 space-y-2 text-sm leading-relaxed", body)}>
                        ...
                        <Bullet><B d={D}>7.3 Privacy Policy.</B> Your use of the Platform is also governed by our Privacy Policy available at: <A href="/privacyPolicy" d={D}>https://whatsnexus.invictusglobaltech.com/Privacy-Policy/</A>.</Bullet>
