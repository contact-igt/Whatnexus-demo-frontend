            ...
            <div className="container mx-auto px-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[8.9px] text-white/30 font-bold tracking-widest uppercase">Powered by Invictus Global Tech Pvt Ltd</span>
                    </div>
                </div>
                <div className="hidden xl:flex items-center gap-4 2xl:gap-8">
                    ...
                    <div className="flex items-center gap-2 2xl:gap-3">
                        <Link href="https://whatsnexus.kingpinventures.in/management/login">
                            <Button variant="secondary" className="px-3 py-2 text-[10px] 2xl:text-[11px] uppercase tracking-widest flex items-center gap-1.5">
                                <LogIn size={14} /> Admin
                            </Button>
                        </Link>
                        <Link href="https://whatsnexus.kingpinventures.in/login">
                            <Button variant="secondary" className="py-2 text-[11px] uppercase tracking-widest flex items-center gap-2">
                                <LogIn size={16} /> Login
                            </Button>
                        </Link>
                ...
                <div className="xl:hidden absolute top-full left-0 right-0 bg-[#0A0A0B] border-b border-white/5 p-6 animate-in slide-in-from-top-2">
                    <nav className="flex flex-col gap-6 text-sm font-bold uppercase tracking-widest text-white/60">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
                            <Link href="https://whatsnexus.kingpinventures.in/management/login" onClick={() => setIsMobileMenuOpen(false)} className="w-full sm:w-1/2">
                            ...
                            <Link href="https://whatsnexus.kingpinventures.in/login" onClick={() => setIsMobileMenuOpen(false)} className="w-full sm:w-1/2">
                                <Button variant="secondary" className="w-full py-3 text-xs uppercase tracking-widest flex items-center justify-center gap-2">
                                    <LogIn size={16} /> Login
                                </Button>
                            </Link>
